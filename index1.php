                   ...
                   <div class="col-md-8">
                     <div class="col-md-4">
                       <form class="" action="editar.php" method="post">
                         <input type="hidden" name="txtIdFac" value="<?php echo $row['idFac'] ?>">
                         <button id="btnEditar" name="btnEditar" type="submit" onclick="editarRegistro();" class="btn btn-small btn-primary">
